...
fun SignInScreen(
    ...
    val launcher = rememberLauncherForActivityResult(contract = ActivityResultContracts.StartActivityForResult()){
        ...
        try {
            ...
            viewModel.googleSignIn(credentials, navController )
        ...
        .padding(start = 30.dp, end = 30.dp), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally)
    {
        ...
        Text(text = "Neuer User? Registriere dich!", fontWeight = FontWeight.Bold, color = Color.Black, fontFamily = FontFamily.Default)

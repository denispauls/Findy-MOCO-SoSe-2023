...
fun SignUpScreen(
    ...
    {
        Text(text = "Findy", fontWeight = FontWeight.Bold, fontSize = 100.sp, color = Color.Black, fontFamily = FontFamily.Default)
        Text(text = "Gebe deine Daten ein", fontWeight = FontWeight.Medium, fontSize = 15.sp, color = Color.Gray, fontFamily = FontFamily.Default)

        TextField(value = email, onValueChange = {
            email = it
        }, modifier = Modifier.fillMaxWidth(), colors = TextFieldDefaults.textFieldColors(backgroundColor = Color.Cyan, cursorColor = Color.Black, disabledLabelColor = Color.Cyan, unfocusedIndicatorColor = Color.Transparent, focusedIndicatorColor = Color.Transparent ),
       ...
       Button(onClick = {
            scope.launch {
                viewModel.registerUser(email,password, navController)
            }
       }, modifier = Modifier
           .fillMaxWidth()
        ...
        Text(text = "Schon einen Account? Dann melde dich an", fontWeight = FontWeight.Bold, color = Color.Black, fontFamily = FontFamily.Default)
